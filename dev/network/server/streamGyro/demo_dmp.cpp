...
void streamGyro::run()
{
    ...
    // otherwise, check for DMP data ready interrupt (this should happen frequently)
	    ...
	    write(_fd, buff, strlen(buff));
            ...
            asprintf(&buff, "ypr  %7.2f %7.2f %7.2f    ", ypr[0] * 180/M_PI, ypr[1] * 180/M_PI, ypr[2] * 180/M_PI);
	    write(_fd, buff, strlen(buff));
        #endif
            ...
            asprintf(&buff, "areal %6d %6d %6d    ", aaReal.x, aaReal.y, aaReal.z);
	    write(_fd, buff, strlen(buff));
        #endif
            ...
            asprintf(&buff, "aworld %6d %6d %6d    ", aaWorld.x, aaWorld.y, aaWorld.z);
	    write(_fd, buff, strlen(buff));
        #endif
